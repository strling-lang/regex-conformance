...
Prospective retry evidence binds that checkpoint chain to a closed causal
policy: predecessor attempt, retry reason, authorization, reset scope and
evidence, environment-realization rule, and retry budget. Committed terminal
evidence is never automatically retried or overwritten. See

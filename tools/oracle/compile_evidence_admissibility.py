#!/usr/bin/env python3
"""Materialize or verify normative/characterization evidence admissibility."""
...
from regex_conformance_schema.evidence_admissibility import materialize, verify_current  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--check", action="store_true", help="verify exact committed artifacts without writing")
    parser.add_argument("--bounded", action="store_true", help="skip broad identity and derivation catalog replay")

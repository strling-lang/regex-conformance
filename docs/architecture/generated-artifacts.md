...
The scientific foundation manifest binds the identity, derivation, execution,
and certification contracts at their accepted integration boundary. Its
content-derived trust assessment proves cross-contract coherence without
claiming full data certification. See the
[scientific foundation](scientific-foundation.md).
...
| Declared-cutoff semantic universe freeze | `tools/semantics/freeze_semantic_universe.py` | adversarial plan, final candidate ledger, frozen snapshot, source-coverage and audit reports, freeze manifest, and semantic authority index | independent search-strategy yield, prior-candidate revalidation, source-orphan and duplicate detection, parent/reference closure, typed additive identities, bounded claim, predecessor immutability, unchanged denominator digests, and deterministic rebuild |
| Accepted semantic knowledge architecture | `tools/semantics/certify_semantic_knowledge.py` | semantic foundation manifest and content-derived acceptance report | exact frozen-authority bindings, researched feature closure, candidate and source reconciliation, non-overlapping ownership, identity and derivation integrity, denominator-readiness fixtures, predecessor immutability, and unchanged denominator digests |
| Explainable prospective obligation rules | `tools/semantics/define_obligation_derivation.py` | versioned rule contract, complete legacy-case reconstruction, representative fixtures, and non-authoritative all-feature dry run | total feature/facet decisions, closed semantic-state and profile-predicate vocabularies, canonical operation and modifier identities, bounded variant and interaction attribution, no generic fallback, deterministic explanation traces, and unchanged predecessor denominator digests |
| Canonical semantic obligation and requirement snapshots | `tools/semantics/generate_obligation_snapshots.py` | permanent identity allocation, obligation and requirement snapshots, predecessor migration ledger, compact semantic projection, materialization report, and current denominator authority index | feature-specific obligation closure, archetype-based minimum evidence cardinality, conditional predicate preservation, characterization isolation, total predecessor reconciliation, identity/lineage validation, deterministic explanation, historical byte stability, and explicit profile-expansion deferral |
| Independently audited semantic denominator | `tools/semantics/audit_scientific_denominator.py` | accounting contract, independent audit report, exact profile-expansion handoff, and current audit authority index | overlap-safe requirement partitions, symbolic expected scenario, closed-predicate validation, archetype cardinality reconstruction, stratified inclusion/exclusion reconstruction, migration closure, stable-ID commitments, hidden-multiplier rejection, and explicit deferral of exact profiles and final execution scale |
| Accepted true obligation denominator | `tools/semantics/certify_true_denominator.py` | denominator foundation manifest and content-derived acceptance report | fresh independent recomputation, adversarial excess and omission attacks, suppression and three-valued conditionality checks, complete explainability and migration closure, historical-byte verification, current C4 binding, and explicit profile-expansion deferral |
| Oracle hierarchy and circularity foundation | `tools/oracle/compile_oracle_foundation.py` | versioned oracle contract, O1–O8 fixtures, validation report, and current authority index | class-specific provenance and judgment ceilings, semantic-requirement compatibility, deep dependency-cycle and authority-domain traversal, conflict preservation, immutable campaign binding, and adversarial anti-laundering cases |
| Normative and characterization evidence admissibility | `tools/oracle/compile_evidence_admissibility.py` | versioned evidence contract, O1–O8 evidence fixtures, immutable expectation-basis fixture, validation report, and current evidence authority index | role/use/conclusion compatibility, source-language strength, immutable provenance, scope coverage, quality-role orthogonality, transitive circularity rejection, shared-authority detection, and adversarial authority-escalation cases |
| Conditional requirement applicability | `tools/applicability/compile_conditional_applicability.py` | versioned applicability contract, synthetic immutable fact fixtures, acceptance report, and current authority index | all 1,972 conditional requirement predicates, stable predicate identities, typed open-world facts, Kleene uncertainty, structured traces, capability dependency cycles, self-reference and skip guards, unchanged semantic denominator, and explicit profile-expansion deferral |
| Observation-to-claim adjudication | `tools/adjudication/compile_adjudication.py` | versioned adjudication contract, synthetic coordinate fixtures, acceptance report, and current authority index | closed state and claim taxonomies, exact predecessor bindings, evidence admission, immutable retry lineage, oracle-bounded comparison, discrepancy history, positive permitted-divergence authority, gate-only waivers, evidence-preserving quarantine, dependency cycles, deterministic traces, unchanged denominator, and C4 at `FAIL — 0/3378` |
